...
function Hero({classes}) {
    return (
        <div className={`h-screen ${classes}`}>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 w-full -translate-y-1/2 mx-auto px-10 md:px-14 lg:px-18 xl:px-22 2xl:px-26 4xl:px-34">
                <div className="grid content-center items-center gap-16">
                    ...
                    <ContactUCTA />
                    <div className="indicator m-auto self-end h-16 w-8" />
                </div>
            </div>
        </div>
    );
