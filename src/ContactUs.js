                    ...
                    <form action="https://api.devsdecide.com/contact-us" method="POST">
                        <div className="grid gap-4 md:gap-8 lg:gap-12">
                            <div className="flex items-center justify-between">
                                <label>Name</label>
                                <input name="name" type="text" required className="w-5/6 text-black" aria-label="name"/>
                            </div>
                            <div className="flex items-center justify-between">
                                <label>Email</label>
                                <input name="email" type="text" required className="w-5/6 text-black" aria-label="email"/>
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                <label>Message</label>
                                <textarea name="message" required className="w-5/6 text-black" aria-label="message"/>
                            </div>
